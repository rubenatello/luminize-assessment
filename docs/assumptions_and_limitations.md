...
- SKU-less platform costs reduce the Amazon-level result but cannot support source-attributed brand or SKU profit from the supplied settlement file. The net-sales allocation is a directional sensitivity scenario, not a posted financial result.
